...
export const ArabicErrors = {
  ...
  noUsersYet:
    'لم يُنشَأ أي مستخدم بعد. على مسؤول الخادم تشغيل تهيئة النظام من مجلد المشروع: npm run server:seed ثم تسجيل الدخول (افتراضي التطوير: بشیر / 101010 إن لم يُعرّف SEED_ADMIN_PASSWORD).',
